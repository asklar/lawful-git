...
- The repo's `examples/git-safety.json` is a sample config that dogfoods the tool — it restricts operations to the `my-project/` path prefix and blocks destructive commands.
